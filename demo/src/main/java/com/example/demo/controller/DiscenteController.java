...
public class DiscenteController {
    ...
    @PostMapping("{idDiscente}/removeCorso/{idCorso}")
    public DiscenteDTO removeCorso(@PathVariable("idDiscente") Integer idDiscente,@PathVariable("idCorso") Integer idCorso) throws Exception{
        return discenteService.removeCorso(idDiscente,idCorso);
    }
